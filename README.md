...
1.4 Copy the folder _Highlight-Automation-Command_ under the _CAST Highlight Code Reader_ folder which is where you have unzipped the "AWS Transform For Downstream automation" extension (the _cast.awstransform.downstreamreview.1.X.X.zip_ file)  
...
Transformed Branch generated by AWS Transform:   _transform-d6a7e41f_
